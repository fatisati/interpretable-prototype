...
In summary, methods that preserve affinity structure remain restricted to within-batch aggregation, while methods that align cells across batches do not preserve this structure. scProto addresses both by combining affinity guidance with cross-batch alignment, without enforcing uniform prototype usage.
